using Checkpoint3_AssetTracking.App;

/*
 * Decided to steer a bit of goal, instead of forcing currency to a location i changed the idea of
 * I bought it in DKK but i store it in tokyo, and the default price is in EUR
 * Just so that i can make use of the currency API more.
 */
